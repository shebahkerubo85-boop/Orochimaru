...
enum class PrefName(val data: Pref) {
    ...
    OnlineSubtitleProviders(Pref(Location.Player, Set::class, setOf("Wyzie", "Stremio", "OpenSubtitles", "SubSource", "SubDL"))),
    ...
    DoubleTapPause(Pref(Location.Player, Boolean::class, true)),
    Speedup(Pref(Location.Player, Boolean::class, false)),
    PreviewSeekbar(Pref(Location.Player, Boolean::class, true)),
    AutoRotateVideo(Pref(Location.Player, Boolean::class, true)),
    PlayerResize(Pref(Location.Player, Boolean::class, true)),
    PlaybackSpeedEnabled(Pref(Location.Player, Boolean::class, true)),
    HideControlNames(Pref(Location.Player, Boolean::class, false)),
    HideSettingsDescriptions(Pref(Location.UI, Boolean::class, false)),
    ShowMediaInfo(Pref(Location.Player, Boolean::class, false)),
    ShowResolution(Pref(Location.Player, Boolean::class, true)),
    SubtitleEncoding(Pref(Location.Player, String::class, "")),
    EpisodeSync(Pref(Location.Player, Boolean::class, true)),
    EnableSkipFromDB(Pref(Location.Player, Boolean::class, true)),
    ProviderLanguage(Pref(Location.Player, String::class, "en")),
    FilterSubLanguage(Pref(Location.Player, Boolean::class, false)),
    TvLayoutClock(Pref(Location.Player, Boolean::class, false)),
    PreferTitleLimit(Pref(Location.Player, Int::class, 0)),
    QualityPrefMobile(Pref(Location.Player, Int::class, Int.MAX_VALUE)),
    BufferDisk(Pref(Location.Player, Int::class, 50)),
    BufferLength(Pref(Location.Player, Int::class, 0)),
